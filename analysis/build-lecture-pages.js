    ...
    sections: [
      {
        title: "1. 점유권의 기본 구조",
        paragraphs: [
          "점유는 물건을 사실상 지배하는 상태입니다. 임차인처럼 소유자가 아니어도 현실적으로 물건을 지배하고 있으면 점유자가 될 수 있습니다.",
          "시험에서는 점유권을 소유권과 혼동시키는 선택지가 자주 나옵니다. 점유는 사실상 지배, 소유는 법률상 권리라는 기준으로 나누면 됩니다.",
        ],
        items: [
          ...
          "점유보호청구권: 점유 침탈, 방해, 방해 위험에 대응하는 청구권입니다.",
        ],
      },
    ],
    concepts: ["점유는 사실상 지배 상태입니다.", "자주점유와 타주점유는 소유 의사 유무로 구분합니다.", "점유보호청구권은 점유 상태 자체를 보호합니다."],
    examPoints: ["점유자와 소유자를 구분합니다.", "취득시효 문제에서는 자주점유, 평온ㆍ공연, 기간을 확인합니다.", "필요비ㆍ유익비 상환은 선의ㆍ악의 점유와 함께 봅니다."],
    practice: ["임차인, 무단점유자, 매수인을 각각 점유 유형으로 분류합니다.", "점유보호청구권 세 종류를 예시와 연결합니다."],
  },
  "제4장 소유권": {
    ...
    sections: [
      {
        title: "1. 소유권의 내용과 제한",
        paragraphs: [
          "소유자는 물건을 사용하고, 그 물건에서 이익을 얻고, 매도ㆍ증여ㆍ담보제공 등 처분을 할 수 있습니다. 그러나 소유권은 무제한 권리가 아니라 법률과 공공복리에 의해 제한됩니다.",
          "공익사업으로 토지가 수용되는 경우도 소유권 제한의 대표 장면입니다. 이때 정당보상 원칙과 손실보상 절차가 함께 작동합니다.",
        ],
        table: {
          headers: ["권능", "뜻", "예시"],
          rows: [
    ...
    concepts: ["소유권은 사용ㆍ수익ㆍ처분 권능을 포함합니다.", "소유권은 공공복리와 법률에 의해 제한될 수 있습니다.", "공유ㆍ합유ㆍ총유는 공동소유 형태입니다."],
    examPoints: ["소유물반환청구, 방해제거청구, 방해예방청구를 구분합니다.", "공유지분의 처분과 공유물 관리ㆍ분할을 나누어 봅니다.", "토지보상에서는 소유권자가 기본 보상대상자입니다."],
    practice: ["소유권의 세 권능을 부동산 사례로 설명합니다.", "공유, 합유, 총유의 차이를 표로 정리합니다."],
  },
  "제5장 용익물권": {
    lead: "용익물권은 타인의 물건을 일정한 목적에 따라 사용하고 수익할 수 있는 제한물권입니다. 지상권, 지역권, 전세권은 모두 사용ㆍ수익 권리이지만 목적과 구조가 다릅니다.",
    sections: [
      {
        title: "1. 지상권, 지역권, 전세권 비교",
        paragraphs: [
          "지상권은 타인의 토지 위에 건물, 공작물, 수목을 소유하기 위해 토지를 사용하는 권리입니다. 지역권은 자기 토지의 편익을 위해 타인의 토지를 이용하는 권리이고, 전세권은 전세금을 지급하고 타인의 부동산을 사용ㆍ수익하는 권리입니다.",
        ],
        table: {
          headers: ["권리", "핵심 목적", "시험 포인트"],
          rows: [
            ["지상권", "타인 토지 위 건물ㆍ공작물ㆍ수목 소유", "등기, 존속기간, 법정지상권"],
            ["지역권", "요역지 편익을 위한 승역지 이용", "요역지와 승역지 관계"],
            ["전세권", "전세금 지급 후 사용ㆍ수익과 전세금 담보", "용익성과 담보성, 등기"],
          ],
        },
      },
    ],
    concepts: ["용익물권은 타인의 물건을 사용ㆍ수익하는 제한물권입니다.", "지상권은 토지 위 건물 등 소유 목적입니다.", "전세권은 사용ㆍ수익 권리이면서 전세금 담보 기능도 있습니다."],
    examPoints: ["지상권, 지역권, 전세권의 목적을 비교합니다.", "법정지상권과 약정지상권을 구분합니다.", "전세권은 임대차와 비교해 등기된 물권이라는 점을 봅니다."],
    practice: ["통행로 이용, 건물 소유 목적 토지 사용, 전세금 지급 사례를 각각 어떤 권리인지 분류합니다."],
  },
  "제6장 담보물권": {
    ...
    sections: [
      {
        title: "1. 담보물권의 비교",
        paragraphs: [
          "유치권은 물건과 관련된 채권을 가진 사람이 그 물건을 점유하면서 반환을 거절할 수 있는 법정담보물권입니다. 질권은 동산이나 권리를 채권자에게 넘겨 담보로 삼는 약정담보물권이고, 저당권은 목적물을 넘기지 않고 등기로 담보를 설정하는 권리입니다.",
        ],
        table: {
          headers: ["권리", "성립 핵심", "공시ㆍ지배", "시험 포인트"],
          rows: [
            ["유치권", "견련성 있는 채권과 적법한 점유", "점유", "법정담보물권, 우선변제권 없음"],
    ...
    concepts: ["담보물권은 채권의 변제를 확보하기 위한 물권입니다.", "유치권은 점유와 견련성이 핵심입니다.", "저당권은 부동산을 넘기지 않고 등기로 담보를 설정합니다."],
    examPoints: ["유치권, 질권, 저당권의 성립요건을 비교합니다.", "질권과 저당권은 목적물 점유 이전 여부로 구분합니다.", "보상금이 지급될 때 담보권자의 우선변제 문제가 연결될 수 있습니다."],
    practice: ["공사대금 미지급 건물 점유, 동산 담보 제공, 부동산 저당권 설정 사례를 각각 분류합니다."],
  },
};
